...
def demo():
    ...
    # 读取本地图片
    filenamePath1 = "../img/LiQin.jpg"  # 测试图片存放在项目目录下
    base64_data1 = ''
    with open(filenamePath1, "rb") as f:
        base64_data1 = base64.b64encode(f.read())

    filenamePath2 = "../img/SunYi.jpg"  # 测试图片存放在项目目录下
    base64_data2 = ''
    with open(filenamePath2, "rb") as f:
    ...
    options = {
        ...
        'method': 'POST',
        'body': json.dumps({"type": "1", "content_1": base64_data1.decode(), "content_2": base64_data2.decode()},
                           separators=(',', ':')),
        'headers': {
